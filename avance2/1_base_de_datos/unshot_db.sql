...
CREATE TABLE IF NOT EXISTS bebidas (
    ...
    nombre      VARCHAR(100) NOT NULL,
    categoria   VARCHAR(30) NOT NULL CHECK (categoria IN ('Clasico','Signature','Premium','Sin Alcohol')),
    descripcion TEXT,
...
CREATE TABLE IF NOT EXISTS reservas (
    ...
    id_cliente   INT NOT NULL REFERENCES clientes(id_cliente) ON UPDATE CASCADE ON DELETE RESTRICT,
    fecha        DATE NOT NULL,
    hora         TIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS pedidos (
    ...
    id_reserva      INT NOT NULL REFERENCES reservas(id_reserva) ON UPDATE CASCADE ON DELETE CASCADE,
    id_bebida       INT NOT NULL REFERENCES bebidas(id_bebida) ON UPDATE CASCADE ON DELETE RESTRICT,
...
('Shot Dorado',  'Clasico',     'Bourbon anejo, miel de ambar, bitter de naranja y hielo esferico.', 38.00),
('Lima Noir',    'Signature',   'Pisco quebranta, maracuya ahumado, espuma de limon y flor de sal.', 42.00),
('Velvet Noche', 'Premium',     'Gin premium, frutos rojos macerados, tonica especiada y romero.',   45.00),
